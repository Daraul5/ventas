...
class Categorias(tk.Frame, Modulos):
    ...
    def widgets(self):
        canvas_categorias = tk.LabelFrame(self, text="Categorias", font="arial 14 bold", bg="#95c799")
        canvas_categorias.place(x=300, y=10, width=780, height=580)
        
        self.canvas = tk.Canvas(canvas_categorias, bg="#95c799")
        ...
        self.label1 = tk.Label(lblframe_seleccion, text="Categoria", font="arial 12 bold", bg="#95c799")
        self.label1.place(x=5, y=5)
        
        self.label2 = tk.Label(lblframe_seleccion, text="Stock", font="arial 12 bold", bg="#95c799")
        self.label2.place(x=5, y=40)
        
        self.label3 = tk.Label(lblframe_seleccion, text="Descripcion", wraplength=200 , font="arial 12 bold", bg="#95c799")
    ...
    def agregar_categoria(self):
        ...
        tk.Label(top, text="Categoría: ", font="arial 12 bold", bg="#95c799").place(x=20, y=20, width=80, height=25)
        entry_categoria = ttk.Entry(top, font="arial 12 bold")
        entry_categoria.place(x=120, y=20, width=250, height=30)

        tk.Label(top, text="Descripción: ", font="arial 12 bold", bg="#95c799").place(x=20, y=60, width=80, height=25)
        ...
        def guardar():
            ...
            # El stock inicial será automáticamente 0
            stock = 0
            ...
            try:
                ...
                # Refrescar combobox y lista de categorías
                self.cargar_categoria()  # Refrescar categorías en la interfaz
                self.categorias_combobox()  # Refrescar los valores en el combobox
                top.destroy()
    ...
    def mostrar_categorias(self, categoria, stock, descripcion, image_rut):
        categoriaframe = tk.Frame(self.scrollable_frame, bg="white", relief="solid")
        ...
        name_label = tk.Label(categoriaframe, text=categoria, bg="white", anchor="w", wraplength=450, font="arial 14 bold", width=60)
        name_label.pack(side="top", fill="both")
        
        stock_label = tk.Label(categoriaframe,text=f"Stock: {stock}",bg="white", anchor="w",wraplength=450,font="arial 14 bold", width=60)
        stock_label.pack(fill="x", anchor="w")
        
        desc_label = tk.Label(categoriaframe, text=f"Descripcion: {descripcion}", bg="white", anchor="w", wraplength=650, font="arial 14 bold", width=60)
    ...
    def editar_categoria(self):
        ...
        tk.Label(top, text="Stock: ", font="arial 12 bold", bg="#95c799").place(x=20, y=60, width=80, height=25)
        ...
        tk.Label(top, text="Descripción: ", font="arial 12 bold", bg="#95c799").place(x=20, y=100, width=80, height=25)
        entry_descripcion = ttk.Entry(top, font="arial 12 bold")
        ...
        def guardar():
            ...
            # Ruta de imagen predeterminada si no hay una seleccionada
            if hasattr(self, "image_rut"):
                image_rut = self.image_rut
            else:
                image_rut = (r"im/def.png")
    ...
    def eliminar_categoria(self):
        ...
        if confirmar:
            try:
                ...
                # Actualiza la lista y el combobox después de eliminar
                self.categoria.remove(categoria_seleccionada)  # Elimina de la lista de categorías
                self.comboboxbuscar['values'] = self.categoria  # Refresca el combobox
                self.cargar_categoria()  # Refresca la lista de categorías

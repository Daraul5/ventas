...
class Ventas(tk.Frame, Modulos):
    ...
    def widgets(self):
        ...
        label_codigo = tk.Label(labelframe, text="Código de Barras", font="sans 14 bold", bg="#95c799")
        ...
        self.label_numero_factura = tk.Label(labelframe, text=f"{self.numero_factura}", font="sans 14 bold", bg="#95c799")
        self.label_numero_factura.place(x=670, y=11)
        ...
        boton_agregar.place(x=90, y=130, width=200, height=40)

        boton_eliminar = tk.Button(labelframe, text="Eliminar producto", font="sans 12 bold", bg="white", command=self.eliminar_articulo)
        boton_eliminar.place(x=310, y=130, width=200, height=40)

        boton_editar = tk.Button(labelframe, text="Editar producto", font="sans 12 bold", bg="white", command=self.editar_articulo)
        boton_editar.place(x=530, y=130, width=200, height=40)

        boton_limpiar = tk.Button(labelframe, text="Cancelar Venta", font="sans 12 bold", bg="white", command=self.cancelar_venta)
        boton_limpiar.place(x=750, y=130, width=200, height=40)
        ...
        # Total de la venta
        self.label_precio_total = tk.Label(self, text="Total a pagar: $0.00", font="sans 18 bold", bg="#95c799")
    ...
    def realizar_pago(self):
        ...
        ventana_pago.config(bg="#95c799")
        ventana_pago.resizable(False, False)

        tk.Label(ventana_pago, text="Realizar Pago", font="sans 30 bold", bg="#95c799").place(x=70, y=10)
        tk.Label(ventana_pago, text=f"Total a pagar: ${total_formateado}", font="sans 14 bold", bg="#95c799").place(x=80, y=100)
    ...
    def ver_ventas_realizadas(self):
        try:
            ...
            ventana_ventas.config(bg="#95c799")
            ...
            label_ventas_realizadas = tk.Label(ventana_ventas, text="Ventas Realizadas", font="sans 26 bold", bg="#95c799")
            label_ventas_realizadas.place(x=350, y=20)
            
            filtro_frame = tk.Frame(ventana_ventas, bg="#95c799")
            filtro_frame.place(x=20, y=60, width=1060, height=60)  
            
            label_factura = tk.Label(filtro_frame, text="Factura:", font="sans 14 bold", bg="#95c799")
            ...
            label_categoria = tk.Label(filtro_frame, text="Categoría:", font="sans 14 bold", bg="#95c799")
    ...
    def generar_factura_pdf(self, total_venta):
        try:
            ...
            empresa_nombre = "Clipperton"
            empresa_direccion = "Berriozabal 29130"
            empresa_telefono = "Tel: 961 123 4567" 
            empresa_email = "clippertoncentro@gmail.com"
            empresa_web = "www.clipperton.com"
            ...
            total_venta = float(total_venta)  # Se asegura que sea float antes de formatear
            ...
            c.save()  # Corrección para guardar el archivo
